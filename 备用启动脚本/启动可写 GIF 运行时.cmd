...
set "PROFILE_ARG="
if /I "%CODEX_SKIN_ISOLATED%"=="1" set "PROFILE_ARG=-UseIsolatedProfile"
set "ACTION=Launch"
if /I "%CODEX_SKIN_PLAN%"=="1" set "ACTION=Plan"
"%POWERSHELL%" -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT%" -ProjectRoot "%PROJECT_ROOT%" -Action %ACTION% %PROFILE_ARG%
